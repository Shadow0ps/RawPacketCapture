...
def main():
	print("Starting Network Traffic Analysis.  Press CTRL-C to interrupt.\n")
	file = open("networkcapture.log","w")
	if os.name == "nt":
	...
	while True:
		...
		if eth_proto == 8:
			...
			file.write(TAB_3 + 'protocol: {}, Source: {}, Target: {}'.format(proto, src, target))
		...
		if eth_proto == 1:
			...
			file.write(TAB_2 + 'Type: {}, Code: {}, Checksum: {},'.format(icmp_type, code, checksum))
			print(TAB_2 + 'ICMP Data:')
			file.write(TAB_2 + 'ICMP Data:')
			print(format_output_line(DATA_TAB_3, data))
			file.write(format_output_line(DATA_TAB_3, data))
		...
		'! H H L L H H H H H H', raw_data[:24])
			...
			file.writee(TAB_3 + 'URG: {}, ACK: {}, PSH: {}'.format(flag_urg, flag_ack, flag_psh))
			...
			if src_port == 80 or dest_port == 80:
				...
				file.write(TAB_2 + 'HTTP Data:')
				try:
					http = HTTP(data)
					http_info = str(http.data).split('\n')
					for line in http_info:
						print(DATA_TAB_3 + str(line))
						file.write(DATA_TAB_3 + str(line))
				except:
					print(format_output_line(DATA_TAB_3, data))
					file.write(format_output_line(DATA_TAB_3, data))
		...
		# Other IPv4
			...
			file.write(format_output_line(DATA_TAB_2, data))

	else:
		print('Ethernet Data:')
		file.write('Ethernet Data:')
		print(format_output_line(DATA_TAB_1, data))
		file.write(format_output_line(DATA_TAB_1, data))
		file.close()
